...
@section('content')
    <div class="shadow p-3 mb-5 bg-white rounded">
        ...
        <form action="" method="get" class="row mb-4 ml-1">
            ...
            <select name="id_purchase" class="form-control col-sm-3 mr-2">
                ...
                @foreach ($pur_req as $vendors)
                    ...
                    <option <?= isset($_GET['id_purchase'])&& isset($_GET['id_purchase']) == $vendors->id_purchase ? "selected" : "" ?> value="{{ $vendors->id_purchase }}">{{ $vendors->id_purchase }}</option>
        ...
        <table class="table table-striped table-hover">
            ...
            <?php 
                $id_purchase = (isset($_GET['id_purchase']) && $_GET['id_purchase'] != "") ? (isset($_GET['id_purchase']) && $_GET['id_purchase'] == $vendors->id_purchase ? true : false) : true;
