...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    ...
    <h1 class="display-4">Wonderful Indonesia</h1>
    <p class="lead">Blog Tourism.</p>
    <p class="lead">Halo, <?php echo e($data_user->name); ?></p>
    <?php endif; ?>
</div>
<div class="container marketing">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <p><a class="btn btn-secondary" href="<?php echo e(URL('/blog_detail/'.$row->id)); ?>" role="button">Lihat Lebih Lengkap
                    &raquo;</a></p>
        </div>
...
<?php echo $__env->make('user.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\Desktop\blog_tourism\resources\views/user/home.blade.php ENDPATH**/ ?>