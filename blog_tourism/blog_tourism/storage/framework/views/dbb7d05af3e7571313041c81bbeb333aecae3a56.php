...
<form class="form-signin" method="POST" action="<?php echo e(URL('/admin/blog_update')); ?>" enctype="multipart/form-data">
    <?php if($message = Session::get('alert-blog-edit-admin')): ?>
        ...
        <div class="col-md-6">
            <center>
                <div>
                    ...
                    ?>
                    <img src="<?php echo e($path); ?>" class="img-thumbnail img-preview" style="max-width: 75%; height: auto;">
                </div>
            </center>
        </div>
    </div>
    <button class="btn btn-lg btn-primary btn-block" type="submit">Simpan</button>
    <a class="btn btn-lg btn-warning btn-block" style="color: #fff;" type="button" href="<?php echo e(URl('/admin/blog_all')); ?>">Kembali</a>
</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\code_yoca\blog_tourism\resources\views/admin/blog_edit.blade.php ENDPATH**/ ?>