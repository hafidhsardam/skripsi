...
<style>
    .card{
        background-image:url("<?php echo e(asset('assets/banner.jpg')); ?>");
        text-align: center;
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown <?= (session('menu_user') == 'categories') ? 'active' : ''; ?>">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        ...
                        <a class="dropdown-item" href="<?php echo e(URl('categories/'.$cat1->id)); ?>"><?php echo e($cat1->name); ?></a>
                ...
                <li class="nav-item <?= (session('menu_user') == 'profil') ? 'active' : ''; ?>">
                    <a class="nav-link" href="<?php echo e(URL('/profile')); ?>">Profil</a>
                </li>
                <li class="nav-item <?= (session('menu_user') == 'blog') ? 'active' : ''; ?>">
                    <a class="nav-link" href="<?php echo e(URL('/blog_all')); ?>">Blog</a>
                </li>
                <li class="nav-item dropdown <?= (session('menu_user') == 'categories') ? 'active' : ''; ?>">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Categories</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
            ...
            <form class="form-inline my-2 my-md-0">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item <?= (session('menu_user') == 'register') ? 'active' : ''; ?>">
                        <a class="nav-link" role="button" href="<?php echo e(URL('/register_user')); ?>"><i class="fa fa-plus"></i> Register</a>
                    </li>
                    <li class="nav-item <?= (session('menu_user') == 'login') ? 'active' : ''; ?>">
                        <a class="nav-link" role="button" href="<?php echo e(URL('/login_user')); ?>"><i class="fa fa-arrow-right"></i> Login</a>
                    </li>
                    <?php else: ?>
                    <li class="nav-item">
...
</html><?php /**PATH C:\Users\ACER\Desktop\blog_tourism\resources\views/user/index.blade.php ENDPATH**/ ?>