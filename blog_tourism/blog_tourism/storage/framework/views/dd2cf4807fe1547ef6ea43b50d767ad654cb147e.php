...
<form class="form-signin" method="post" action="<?php echo e(URL('admin/profile_update')); ?>">
    <?php echo csrf_field(); ?>
    <center>
        <h1 class="h3 mb-3 font-weight-normal">Admin Profile Update</h1>
    </center>
    <?php if($message = Session::get('alert-update-profile-admin')): ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\code_yoca\blog_tourism\resources\views/admin/profile.blade.php ENDPATH**/ ?>