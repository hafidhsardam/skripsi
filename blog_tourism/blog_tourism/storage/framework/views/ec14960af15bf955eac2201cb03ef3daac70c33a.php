...
<form class="form-signin" method="POST" action="<?php echo e(URL('blog_update')); ?>" enctype="multipart/form-data">
    <?php if($message = Session::get('alert-blog-edit')): ?>
...
<?php echo $__env->make('user.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\code_yoca\blog_tourism\resources\views/user/blog_edit.blade.php ENDPATH**/ ?>