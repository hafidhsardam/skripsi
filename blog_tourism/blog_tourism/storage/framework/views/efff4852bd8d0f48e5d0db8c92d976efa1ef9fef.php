...
<form class="form-signin" method="POST" action="<?php echo e(URL('/admin/blog_store')); ?>" enctype="multipart/form-data">
    <?php if($message = Session::get('alert-blog-add-admin')): ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\code_yoca\blog_tourism\resources\views/admin/blog_add.blade.php ENDPATH**/ ?>