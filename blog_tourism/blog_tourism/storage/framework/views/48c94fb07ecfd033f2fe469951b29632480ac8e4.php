    ...
    <div class="container marketing">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-secondary" href="<?php echo e(URL('admin/blog_detail/'.$row->id)); ?>" role="button">Lihat Lebih Lengkap &raquo;</a></p>
            </div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\code_yoca\blog_tourism\resources\views/admin/categories_blog_all.blade.php ENDPATH**/ ?>