...
<form class="form-signin" method="POST" action="{{ URL('/admin/blog_update') }}" enctype="multipart/form-data">
    @if ($message = Session::get('alert-blog-edit-admin'))
    ...
    <a class="btn btn-lg btn-warning btn-block" style="color: #fff;" type="button" href="{{ URl('/admin/blog_all') }}">Kembali</a>
</form>
@endsection